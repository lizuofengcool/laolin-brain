...
> **最后更新**: 2026-05-26  
> **当前状态**: 📋 开发文档编写中  
> **技术栈**: Next.js 15 + shadcn/ui + SQLite + Prisma  
...
|------|------|---------|------|
| 1.1 | 项目初始化 + 依赖安装 | - | ⏳ 待开发 |
| 1.2 | 数据库 Schema 设计 + Prisma 配置 | - | ⏳ 待开发 |
| 1.3 | 存储适配器架构搭建（base/indexeddb/server/factory） | - | ⏳ 待开发 |
| 1.4 | 用户认证系统（注册/登录/登出） | - | ⏳ 待开发 |
| 1.5 | 文件上传功能（拖拽+选择，支持 Word/PDF/图片） | - | ⏳ 待开发 |
| 1.6 | 文档解析模块（Word→mammoth，PDF→pdf-parse） | - | ⏳ 待开发 |
| 1.7 | 文件管理界面（列表/网格视图、标签、收藏、文件夹） | - | ⏳ 待开发 |
| 1.8 | 全局搜索功能（文本匹配，文档+图片） | - | ⏳ 待开发 |
| 1.9 | 存储模式切换设置页面 | - | ⏳ 待开发 |
| 1.10 | 用户仪表盘首页（空间统计、最近文件、快捷操作） | - | ⏳ 待开发 |
| 1.11 | UI 美化 + 响应式适配 | - | ⏳ 待开发 |
| 1.12 | 自检测试 + 修复 | - | ⏳ 待开发 |
...
| 步骤 | 内容 | 预计耗时 | 状态 |
|------|------|---------|------|
| 2.1 | AI API 接口对接框架搭建 | - | ⏳ 待开发 |
| 2.2 | 图片上传 + OCR 文字识别入库 | - | ⏳ 待开发 |
| 2.3 | 图片场景/物品语义识别 | - | ⏳ 待开发 |
| 2.4 | AI 问答：选中文档/图片，AI 解读内容 | - | ⏳ 待开发 |
| 2.5 | 搜索结果优化（按相关性排序） | - | ⏳ 待开发 |
| 2.6 | 自检测试 + 修复 | - | ⏳ 待开发 |
...
| 步骤 | 内容 | 预计耗时 | 状态 |
|------|------|---------|------|
| 3.1 | PPT 文件上传 + 逐页解析 | - | ⏳ 待开发 |
| 3.2 | 人脸聚类识别 + 人名标注 | - | ⏳ 待开发 |
| 3.3 | 人名关键词搜索照片 | - | ⏳ 待开发 |
| 3.4 | 时间线浏览模式 | - | ⏳ 待开发 |
| 3.5 | 语义搜索（向量检索） | - | ⏳ 待开发 |
| 3.6 | UI 全面优化 + 动画效果 | - | ⏳ 待开发 |
| 3.7 | 性能优化（大文件处理、分页加载） | - | ⏳ 待开发 |
| 3.8 | 自检测试 + 修复 | - | ⏳ 待开发 |
